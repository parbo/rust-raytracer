...
fn trace(/*amb, lights, obj, */ depth: u32, raypos: Vec3, raydir: Vec3) -> Pixel {
    [1.0, 0.0, 0.0]
}

fn render(/*amb, lights, obj, */ depth: u32, fov: f64, w: u32, h: u32, filename: &str) {
    ...
    for iy in 0..h {
        ...
        for ix in 0..w {
            ...
            let p = trace(/*amb, lights, obj, */depth, raypos, raydir);
            pixels.push(p);
        }
    }
